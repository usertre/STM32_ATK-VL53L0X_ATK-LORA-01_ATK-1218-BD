...
void vl53l0x_general_test(VL53L0X_Dev_t *dev)
{
	...
	{	
		...
		else if(key==KEY1_PRES)//选择工作模式
		{
			 ...
			 switch(mode)
			 {
				 case Default_Mode:  printf("Default");break;//LCD_ShowString(95,140+95,300,16,16, "Default        "); break;//默认
				 case HIGH_ACCURACY: printf("High Accuracy");break;//LCD_ShowString(95,140+95,300,16,16, "High Accuracy  "); break;//高精度
				 case LONG_RANGE:    printf("Long Range");break;//LCD_ShowString(95,140+95,300,16,16, "Long Range     "); break;//长距离
				 case HIGH_SPEED:    printf("High Speed");break;//LCD_ShowString(95,140+95,300,16,16, "High Speed     "); break;//高速
			 }
		}	
